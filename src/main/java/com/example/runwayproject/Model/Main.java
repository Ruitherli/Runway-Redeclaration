...
//int tora, int toda, int asda, int lda, String runwayName
        ...
        Obstacle o3 = new Obstacle("obs 3",15,10,10,150,3203,60,Obstacle.Direction.North);
        Obstacle o4 = new Obstacle("obs 4",20,10,10,50,3546,20,Obstacle.Direction.North);
        ...
        Calculator.calcAll(runway1, o1);

        System.out.println("----scenario 2----");
        //Calculator.calcAll(l2, r2, o2);
        Calculator.calcAll(runway2, o2);

        System.out.println("----scenario 3----");
        //Calculator.calcAll(l2, r2, o3);
        Calculator.calcAll(runway2, o3);

        System.out.println("----scenario 4----");
        //Calculator.calcAll(l1, r1, o4);
        Calculator.calcAll(runway1, o4);
